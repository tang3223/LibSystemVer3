...
<!--           <div class="row placeholders">
          ...
          <div class="panel panel-default" id="tableAndPages">
			  <div class="panel-heading">
 				<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editGenreModel"
 					href="addgenre.jsp">Add Genre</button>
<%--            		<div class="pull-right" id="page-selection">
			  ...
			  <table class="table table-striped">
                ...
                <tr>
                  ...
                  <th><h4><span class="label label-primary">Genre Name</span></h4></th>
...
<%-- 				<% if(request.getAttribute("index") != null){
                ...
                <tr>
                  ...
                  <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editGenreModel"
						href="editgenre.jsp?genreId=<%=genre.getGenreId()%>">Update</button></td>
                  <td><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#editGenreModel"
						href="deletegenre.jsp?genreId=<%=genre.getGenreId()%>">Delete</button></td>
                </tr>
               	<% } %>
              </tbody>        
			 </table>
...
<div class="modal fade" id="editGenreModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
